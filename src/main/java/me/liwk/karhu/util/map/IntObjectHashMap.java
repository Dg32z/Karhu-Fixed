...
public class IntObjectHashMap<V> implements IntObjectMap<V> {
   ...
   final class MapEntry implements Entry<Integer, V> {
      ...
      public V getValue() {
         this.verifyExists();
         return IntObjectHashMap.this.values[this.entryIndex];
      }

      @Override
      public V setValue(V value) {
         this.verifyExists();
         V prevValue = IntObjectHashMap.this.values[this.entryIndex];
         IntObjectHashMap.this.values[this.entryIndex] = value;
         return prevValue;
      }
   ...
   private final class PrimitiveIterator implements Iterator<IntObjectMap.PrimitiveEntry<V>>, IntObjectMap.PrimitiveEntry<V> {
      ...
      private void scanNext() {
         while (++this.nextIndex != IntObjectHashMap.this.values.length
                 && IntObjectHashMap.this.values[this.nextIndex] == null) {
         }
      }
