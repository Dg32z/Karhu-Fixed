...
public class MathHelper {
    ...
    private static final float radToIndex = MathHelper.roundToFloat(651.8986469044033);
    ...
    static {
        ...
        for (int l = 0; l < 360; l += 90) {
            MathHelper.SIN_TABLE_FAST[(int)((float)l * 11.377778f) & 0xFFF] = (float)Math.sin((float)l * ((float)Math.PI / 180));
        }
