...
implements Cloneable {
    ...
    public double distance(CustomLocation o) {
        return Math.sqrt(NumberConversions.square((double)(this.x - o.x)) + NumberConversions.square((double)(this.y - o.y)) + NumberConversions.square((double)(this.z - o.z)));
    }

    public double distance(Location o) {
        return Math.sqrt(NumberConversions.square((double)(this.x - o.getX())) + NumberConversions.square((double)(this.y - o.getY())) + NumberConversions.square((double)(this.z - o.getZ())));
    }

    public double horizontal(CustomLocation o) {
        return Math.sqrt(NumberConversions.square((double)(this.x - o.x)) + NumberConversions.square((double)(this.z - o.z)));
    }

    public double horizontal(Location o) {
        return Math.sqrt(NumberConversions.square((double)(this.x - o.getX())) + NumberConversions.square((double)(this.z - o.getZ())));
    }
