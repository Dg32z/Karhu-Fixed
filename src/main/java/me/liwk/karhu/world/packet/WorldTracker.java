...
public class WorldTracker {
    ...
    public void handleData(WrapperPlayServerChunkData packet) {
        ...
        BaseChunk[] chunks = new ChunkReader_v1_18().read(null, null, null, true, false, false, 69, null, new NetStreamInput(new ByteArrayInputStream(packet.getColumn().getBiomeDataBytes())));
