...
public final class FrictionLookup {
    ...
    public static float lookup(KarhuPlayer data) {
        ...
        Location loc = new Location(
                data.getWorld(),
                MathHelper.floor_double(data.getLastLocation().getX()),
                MathHelper.floor_double(data.getLastLocation().getY() - downLookup),
                MathHelper.floor_double(data.getLastLocation().getZ())
        );
