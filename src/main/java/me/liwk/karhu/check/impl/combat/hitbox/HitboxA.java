                ...
                if (packet instanceof FlyingEvent) {
                    for(int target : this.data.getLastTargets()) {
                        if (this.data.getGameMode() != GameMode.CREATIVE
                            ...
                            float sneakAmount1_8 = !this.data.isWasSneaking() && !this.data.isWasWasSneaking()
                                    ? (this.data.isGliding() ? 0.4F : (this.data.isRiptiding() ? 0.4F : 1.62F))
                                    : 1.54F;
                            float sneakAmount1_13 = !this.data.isWasSneaking() && !this.data.isWasWasSneaking()
                                    ? (this.data.isGliding() ? 0.4F : (this.data.isRiptiding() ? 0.4F : 1.62F))
                                    : 1.27F;
                            Vec3 eyeLocation = MathUtil.getPositionEyes(
                                    this.data.attackerX, this.data.attackerY, this.data.attackerZ, !this.data.isNewerThan12() ? sneakAmount1_8 : sneakAmount1_13
                            );
