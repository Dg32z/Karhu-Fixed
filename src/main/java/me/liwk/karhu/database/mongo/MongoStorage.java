...
public class MongoStorage implements Storage {
   ...
   public MongoStorage() {
      ...
      this.authentication = cfg.getConfig().getString("mongo.authentication.database");
   ...
   public void init() {
      MongoClient client;
      if (this.auth) {
         MongoCredential credentials = MongoCredential.createCredential(this.username, this.authentication, this.password.toCharArray());
