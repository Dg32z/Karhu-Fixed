...
public class EntityData {
    ...
    public List<Vector> newLocations = new ArrayList<Vector>();
    ...
    public void interpolate() {
        if (this.posIncrements > 0) {
            ...
            double newMaxX = -1.7976931348623157E308;
            double newMaxY = -1.7976931348623157E308;
            double newMaxZ = -1.7976931348623157E308;
