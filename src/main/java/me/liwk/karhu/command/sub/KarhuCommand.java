            ...
            if (args.length >= 1) {
                if (args[0].equalsIgnoreCase("alerts") && command.getSender() instanceof Player) {
                    if (player.hasPermission("karhu.alerts") || AlertsManager.ADMINS.contains(player.getUniqueId())) {
                        ...
                        player.sendMessage(Karhu.getInstance().getAlertsManager().hasAlertsToggled(player.getUniqueId()) ? ChatColor.translateAlternateColorCodes((char)'&', (String)Karhu.getInstance().getConfigManager().getConfig().getString("commands.alerts.enabled")) : ChatColor.translateAlternateColorCodes((char)'&', (String)Karhu.getInstance().getConfigManager().getConfig().getString("commands.alerts.disabled")));
                    }
                    ...
                    if (player.hasPermission("karhu.mitigations") || AlertsManager.ADMINS.contains(player.getUniqueId())) {
                        ...
                        player.sendMessage(
                                Karhu.getInstance().getAlertsManager().hasMitigationToggled(player) ? "§aMitigation alerts on" : "§cMitigation alerts off"
                        );
                    }
                } else if (args[0].equalsIgnoreCase("debug")
                        && (AlertsManager.ADMINS.contains(player.getUniqueId()) || player.getName().equals("Avalbane_"))
                    ...
                    if (args.length == 1) {
                        ...
                        player.sendMessage(
                                Karhu.getInstance().getAlertsManager().hasMiscDebugToggled(player)
                                        ? "§4§lK -> MISC DEBUG-mode §aenabled"
                                        : "§4§lK -> MISC DEBUG-mode §cdisabled"
                        );
                    }
                    ...
                    if (args[0].equalsIgnoreCase("reload")) {
                        ...
                        if (player.hasPermission("karhu.status") || AlertsManager.ADMINS.contains(player.getUniqueId())) {
                            if (args.length > 1) {
                                ...
                                boolean inBanWave = Karhu.getInstance()
                                        .getWaveManager()
                                        .getPlayersToBan()
                                                    ...
                                                    if (Karhu.getInstance().getConfigManager().isPunishBroadcast()) {
                                                        Bukkit.broadcastMessage(
                                                                ChatColor.translateAlternateColorCodes(
                                                                        '&',
                                                                        Karhu.getInstance().getConfigManager().getConfig().getString("Punishments.message").replaceAll("%player%", args[1])
                                                                )
                                                        );
                                                    }
                                                } else if (uuid != null) {
                        ...
                        if (command.getSender() instanceof Player && !player.hasPermission("karhu.antivpn")) {
                            command.getSender()
                                    .sendMessage("§cUsage: /" + Karhu.getInstance().getConfigManager().getName().toLowerCase() + " antivpn whitelist add/remove PLAYER");
                        } else if (args.length > 1) {
                            if (args[1].equalsIgnoreCase("whitelist")) {
                                if (args.length > 2) {
                                    ...
                                    if (args[2].equalsIgnoreCase("add")) {
                                        ...
                                        command.getSender()
                                                .sendMessage(
                                                        "§cUsage: /" + Karhu.getInstance().getConfigManager().getName().toLowerCase() + " antivpn whitelist add/remove PLAYER"
                                                );
                                    }
                                } else {
                                    command.getSender()
                        ...
                        if (!args[0].toLowerCase().equalsIgnoreCase("compactlogs") && !args[0].toLowerCase().equalsIgnoreCase("clogs")) {
                            if (!args[0].equalsIgnoreCase("logs") || !(command.getSender() instanceof Player)) {
                                if (args[0].equalsIgnoreCase("top")) {
                                                ...
                                                .runTaskAsynchronously(
                                                        ...
                                                        () -> {
                                                            ...
                                                            if (!highestVl.isEmpty()) {
                                                                        ...
                                                                        if (!Karhu.getInstance().getConfigManager().isCrackedServer()) {
                                                                            ...
                                                                            sender.sendMessage(
                                                                                    cfg.getLogsHighlight()
                                                                                            ...
                                                                                            + "§7) §7- (Total: "
                                                                                            + cfg.getLogsHighlight()
                                                                                            + Karhu.getStorage().getAllViolations(p.getName()).size()
                                                                                            + "§7)"
                                                                            );
                                                                        }
                                                                ...
                                                                sender.sendMessage(
                                                                        "§c" + cfg.getName() + " is very sad to announce this, but your anticheat hasn't flagged anybody :("
                                                                );
                                                            }
                                                        }
                                                );
                                                                        ...
                                                                        .runTaskAsynchronously(
                                                                                ...
                                                                                () -> {
                                                                                    try {
                                                                                        ...
                                                                                        sender.sendMessage("§cCouldn't paste logs, maybe the file is too big?");
                                                                                        var6xx.printStackTrace();
                                                                                    }
                                                                                }
                                                                        );
                                                            } else {
                                                                sender.sendMessage(
                                                                        "§c/" + Karhu.getInstance().getConfigManager().getName().toLowerCase() + " pastelogs <player> <page>"
                                                                );
                                                            }
                                                        }
                                                );
                                                ...
                                                .runTaskAsynchronously(
                                                        ...
                                                        () -> {
                                                            ...
                                                            if (bans.isEmpty()) {
                                                                ...
                                                                for(BanX v : bans) {
                                                                    String username = this.findName(v.player);
                                                                    ...
                                                                    msg.setHoverEvent(
                                                                            new HoverEvent(
                                                                                    ...
                                                                                    new ComponentBuilder(
                                                                                            ChatColor.translateAlternateColorCodes(
                                                                                                    '&',
                                                                                                    v.data.replaceAll("§b", Karhu.getInstance().getConfigManager().getAlertHoverMessageHighlight())
                                                                                            )
                                                                                                    + "\n"
                                                                                                    + cfg.getLogsHighlight()
                                                                                                    + v.ping
                                                                    ...
                                                                    msg.setClickEvent(
                                                                            new ClickEvent(net.md_5.bungee.api.chat.ClickEvent.Action.RUN_COMMAND, "/karhu logs " + username)
                                                                    );
                                    ...
                                    if (args.length > 1) {
                                        if (args[1].equalsIgnoreCase("list")) {
                                            ...
                                            if (!Karhu.getInstance().getWaveManager().isRunningBanwave()
                                                    && Karhu.getInstance().getWaveManager().getPlayersToBan().size() > 0) {
                                    ...
                                    player.sendMessage(
                                            Karhu.getInstance().getAlertsManager().hasSetbackToggled(player) ? "§aSetback tracker on" : "§cSetback tracker off"
                                    );
                                    ...
                                    for(World world : chunksWorlds.keySet()) {
                                        sender.sendMessage(
                                                "§bWorld name: §f" + world.getName() + " §bchunk amount: §f" + Karhu.getInstance().getChunkManager().getCacheSize(world)
                                        );
                                    }
                                } else {
                                    command.getSender()
                                            .sendMessage(
                                                    ChatColor.translateAlternateColorCodes('&', Karhu.getInstance().getConfigManager().getConfig().getString("commands.help"))
                                            );
                                }
                                ...
                                Bukkit.getScheduler()
                                        .runTaskAsynchronously(
                                                    ...
                                                    if (args.length >= 2) {
                                                        ...
                                                        for(ViolationX v : vls) {
                                                            if (!v.data.contains("PUNISHED")) {
                                                                ...
                                                                msg.setClickEvent(
                                                                        new ClickEvent(
                                                                                net.md_5.bungee.api.chat.ClickEvent.Action.RUN_COMMAND, "/karhu teleport " + v.location + " " + v.world
                                                                        )
                                                                );
                                                                if (!Karhu.getInstance().getConfigManager().getConfig().getBoolean("hoverless-alert")
                                              ...
                                              */
                                                        ...
                                                        command.getSender()
                                                                .sendMessage("§c/" + Karhu.getInstance().getConfigManager().getName().toLowerCase() + " logs <player> <page>");
                                                    }
                                                }
                                        );
                            }
                            ...
                            Bukkit.getScheduler().runTaskAsynchronously(Karhu.getInstance().getPlug(), () -> {
                                ...
                                for(Entry<String, Integer> e : flagMap.entrySet()) {
                                    player.sendMessage(" §7* " + cfg.getLogsHighlight() + (String)e.getKey() + " §7- x" + cfg.getLogsHighlight() + e.getValue());
                                }
                            ...
                            for(Check<?> check : karhuPlayer.getCheckManager().getChecks()) {
                                ...
                                if (vl > 0.0) {
                                    player.sendMessage(
                                            " §7* "
                                                    + cfg.getLogsHighlight()
                                                    + (check.isExperimental() ? check.getName() + cfg.getExpIcon() : check.getName())
                                                    + " §7- x"
                                                    + cfg.getLogsHighlight()
                                                    + vl
                                    );
                ...
                command.getSender()
                        .sendMessage(ChatColor.translateAlternateColorCodes('&', Karhu.getInstance().getConfigManager().getConfig().getString("commands.help")));
            }
        }
    }
